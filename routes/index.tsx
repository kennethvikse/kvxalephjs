...
const externalLinks = [
  ...
  ["Github", "https://github.com/kennethvikse"],
];
...
export default function Index() {
  return (
    ...
    >
      <Head>
        <title>Kenneth</title>
        <meta name="description" content="Welcome! My name is Kenneth." />
      </Head>
      <p className="logo">
      ...
      <p className="text-center text-md text-gray-800">
        Learning <strong> AlephJS </strong> and how to use it.
        <br /> A Deno Framework with modern toolings.
      </p>
